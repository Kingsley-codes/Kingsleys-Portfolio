    ...
    <nav className="fixed top-0 w-full z-50 border-b border-white/5 glass-nav">
      <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-[#2c9b8c] rounded-lg flex items-center justify-center text-white font-bold text-xl">
            <FiTerminal />
          </div>
          <h1 className="font-bold text-gray-200 text-xl tracking-tight hidden sm:block">
            Kingsley Emeka
          </h1>
        </div>
